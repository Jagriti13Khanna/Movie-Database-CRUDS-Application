...
<div class="edit">
        ...
        if($list_result->num_rows > 0)
        {
            ...
            while($list_row = $list_result->fetch_assoc())
            {
                extract($list_row);
                echo "<li>";
                echo "<a href=\"edit2.php?row_to_edit=$movie_id\">";
                echo "$movie_name";
                echo "</a>";
                echo "</li>";
            }
...
<div class="no-flex">
    ...
    <div class="iblock">
        <fieldset class="category">
            ...
            <input type="radio" name="category" <?php if (isset($new_category) && $new_category == "fictional") echo "checked";  else {echo "checked";}?> value="fictional">Fictional
              <input type="radio" name="category" <?php if (isset($new_category) && $new_category=="non-fictional") echo "checked";  else {echo "checked";}?> value="non-fictional">Non Fictional
        </fieldset>
    ...
    <div class="iblock">
        <fieldset class="child_lead">
            ...
            <input type="radio" name="child_lead" <?php if (isset($new_child_lead) && $new_child_lead == "yes") echo "checked"; else {echo "checked";}?> value="yes">Yes
              <input type="radio" name="child_lead" <?php if (isset($new_child_lead) && $new_child_lead =="no") echo "checked"; else {echo "checked";}?> value="no">No
        </fieldset>
